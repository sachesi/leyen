...
install -Dpm 0644 packaging/usr/share/icons/hicolor/256x256/apps/%{app_id}.svg \
  %{buildroot}%{_datadir}/icons/hicolor/256x256/apps/%{app_id}.svg

# Shell completions. Source files live under packaging/ using canonical filesystem
# layout; install Bash completion as "leyen" for bash-completion lookup.
install -Dpm 0644 packaging/usr/share/bash-completion/completions/leyen.bash \
  %{buildroot}%{_datadir}/bash-completion/completions/%{name}

install -Dpm 0644 packaging/usr/share/fish/vendor_completions.d/leyen.fish \
  %{buildroot}%{_datadir}/fish/vendor_completions.d/%{name}.fish

install -Dpm 0644 packaging/usr/share/zsh/site-functions/_leyen \
...
* Sun Apr 26 2026 sachesi <xsachesi@pm.me> - 0.2.2-3
- Update packaging

* Sun Apr 26 2026 sachesi <xsachesi@pm.me> - 0.2.2-2
- Update packaging
- Update completions
- Fix version

* Sun Apr 26 2026 sachesi <xsachesi@pm.me> - 0.2.2-1
- UI: hide unavailable MangoHud and GameMode toggles
- Bump version to 0.2.2

* Sun Apr 26 2026 sachesi <xsachesi@pm.me> - 0.2.1-1
- Modify README, add documentation
- Add pregenerated Bash, Fish, and Zsh completions under assets

* Sun Apr 26 2026 sachesi <xsachesi@pm.me> - 0.2.0-1
...
* Sat Apr 25 2026 sachesi <xsachesi@pm.me> - 0.1.5-1
...
* Sat Apr 25 2026 sachesi <xsachesi@pm.me> - 0.1.4-1
